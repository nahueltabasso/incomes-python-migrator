...
A Python-based data migration tool that pulls user and financial data from an external API, more specifically from a personal project called https://github.com/nahueltabasso/backend-ingreso-egreso[IngresoEgreso] and persists it into a MySQL database using SQLAlchemy and Alembic.
...
----
mysql -h 127.0.0.1 -P 3300 -u user -p -e "CREATE DATABASE ingreso_egreso_db_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
----
